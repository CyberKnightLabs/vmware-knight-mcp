...
DESTRUCTIVE_CLI_COMMANDS: list[tuple[str, str]] = [
    ("vmware_knight/cli/vm.py", "vm_power_off"),
    ("vmware_knight/cli/vm.py", "vm_delete"),
    ("vmware_knight/cli/vm.py", "vm_snapshot_revert"),
    ("vmware_knight/cli/vm.py", "vm_snapshot_delete"),
    ("vmware_knight/cli/vm.py", "vm_clone"),
    ("vmware_knight/cli/vm.py", "vm_migrate"),
    ("vmware_knight/cli/cluster.py", "cluster_delete_cmd"),
    ("vmware_knight/cli/cluster.py", "cluster_remove_host_cmd"),
    ("vmware_knight/cli/alarm.py", "alarm_reset"),
]
