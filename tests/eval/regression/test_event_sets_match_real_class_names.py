"""Regression — VMware Knight's event sets match what pyVmomi really hands back.

VMware Knight ranks events with CRITICAL_EVENTS / WARNING_EVENTS / INFO_EVENTS written as
