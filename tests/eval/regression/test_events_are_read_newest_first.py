"""Regression — VMware Knight event reads return the newest events.

VMware Knight called ``EventManager.QueryEvents`` directly in two places: the event
...
newest-first (``vmware_monitor.ops.health.read_events``); VMware Knight now goes through
...
from vmware_knight.ops import health
from vmware_knight.scanner import log_scanner
