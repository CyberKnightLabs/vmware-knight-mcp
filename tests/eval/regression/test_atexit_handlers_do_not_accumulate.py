...
reconnects after each session expiry ( #40) accumulated one dead
...
from vmware_knight.connection import ConnectionManager, _release_si
...
def _password(monkeypatch):
    ...
    monkeypatch.setenv("VMWARE_KNIGHT_VCENTER_PROD_PASSWORD", "test-only")
