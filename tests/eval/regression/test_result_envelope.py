...
Regression source: VMware Knight issue #31 (juanpf-ha). Driving the family with
...
from vmware_knight.ops import alarm_mgmt, datastore_browser, planner, ttl
...
def test_batch_write_tools_still_return_a_bare_list(tool_name) -> None:
    ...
    judgement.
    """
    from vmware_knight.mcp_server.tools import deploy
