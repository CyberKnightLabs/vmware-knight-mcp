...
from vmware_knight.mcp_server._shared import AUTHORED_MESSAGE_CAP, _safe_error
from vmware_knight.mcp_server.server import mcp
from vmware_knight.ops import guest_ops

_REPO = pathlib.Path(__file__).resolve().parents[3]
SKILL_MD = _REPO / "skills" / "vmware-knight" / "SKILL.md"
...
def test_skill_md_read_write_split_matches_the_annotations() -> None:
    ...
    A prose count with no mechanical link to the code drifts silently ( #6),
