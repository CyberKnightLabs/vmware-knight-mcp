...
exist because of VMware Knight issue #31, where a model handed a bare list
...
from vmware_knight.ops import datastore_browser, host_network_mgmt, network_mgmt
...
class TestScannedImages:
    ...
    def _tool(self, monkeypatch, registry):
        from vmware_knight.mcp_server.tools import datastore as dt
