...
import vmware_knight.mcp_server.tools.guest as guest_tools
import vmware_knight.mcp_server.tools.plan as plan_tools
import vmware_knight.mcp_server.tools.ttl as ttl_tools
import vmware_knight.mcp_server.tools.vm as vm_tools
from vmware_knight.ops import gate as gate_mod
from vmware_knight.ops import inventory, plan_executor, planner, ttl, vm_lifecycle
from vmware_knight.ops.gate import GateRefusedError, refuse_on
...
def test_every_destructive_step_is_checked_immediately_before_it_runs(
    ...
    from vmware_knight.ops import plan_gate
...
def test_guest_exec_over_the_cap_is_flagged_and_refused(served, monkeypatch):
    from vmware_knight.ops.guest_gate import MAX_COMMAND_CHARS
