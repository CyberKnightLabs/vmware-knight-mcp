...
from vmware_knight.ops import inventory, vm_lifecycle
from vmware_knight.ops.inventory import AmbiguousVMError, find_vm_by_name
...
def test_total_size_counts_disks_beyond_the_listed_cap(inventory_of):
    from vmware_knight.ops.vm_delete_gate import MAX_LISTED_DISKS
...
def test_a_plan_delete_step_without_acknowledgement_is_refused(inventory_of):
    from vmware_knight.ops import plan_executor
...
def test_a_plan_accepts_the_acknowledgement_parameter():
    from vmware_knight.ops.planner import _ACTION_SCHEMA
