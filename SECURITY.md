...
- **GitHub**: Open a [private security advisory](https://github.com/vmware-skills/VMware Knight/security/advisories/new)
...
- Passwords are stored exclusively in `~/.vmware-knight/.env` (never in `config.yaml`, never in code)
