...
from vmware_knight.ops.vm_lifecycle import create_snapshot, power_on_vm
    ...
    with tarfile.open(ova_path, "r", encoding="utf-8") as tar:
        ...
        if total_size > _MAX_TAR_TOTAL_SIZE:
            raise ValueError(
                ...
                f"deploy_vm_from_template (CLI: vmware-knight deploy template) for "
