...
from vmware_knight.config import CONFIG_DIR
from vmware_knight.ops.inventory import find_datastore_by_name

if TYPE_CHECKING:
    from pyVmomi.vim import ServiceInstance

_log = logging.getLogger("vmware-knight.datastore")
...
def scan_all_datastores(si: ServiceInstance) -> dict[str, list[dict]]:
    ...
    """
    from vmware_knight.ops.inventory import list_datastores
