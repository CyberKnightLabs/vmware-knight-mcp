...
class AuditLogger:
    ...
    Logs to ``~/.vmware-knight/audit.log`` by default.  Each entry records
    *what* was done, *where*, *before/after* state, and *who* initiated it.
    """

    def __init__(self, log_file: str = "~/.vmware-knight/audit.log") -> None:
        ...
        try:
            ...
            pass
        self._logger = logging.getLogger("vmware-knight.audit")
