...
def alarm_list(
    ...
    from vmware_knight.ops.alarm_mgmt import list_alarms
...
def alarm_acknowledge(
    ...
    from vmware_knight.ops.alarm_mgmt import acknowledge_alarm
...
def alarm_reset(
    ...
    """
    from vmware_knight.ops.alarm_mgmt import reset_alarm
    ...
    _double_confirm("", f"{entity_name}/{alarm_name}", _resolve_target(target), resource_type="Alarm")
    si, _ = _get_connection(target, config)
