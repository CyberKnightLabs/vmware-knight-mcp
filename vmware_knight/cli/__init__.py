"""CLI package for vmware-knight.

Re-exports `app` so the pyproject.toml entry point
``vmware-knight = "vmware_knight.cli:app"`` continues to work unchanged.
"""

from vmware_knight.cli._root import app
import sys
...
import vmware_knight.policy_environment  # noqa: E402,F401
