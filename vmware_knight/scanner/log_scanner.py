...
from vmware_knight.config import ScannerConfig
from vmware_knight.ops.health import CRITICAL_EVENTS, WARNING_EVENTS
from vmware_knight.ops.inventory import _collect

if TYPE_CHECKING:
    from pyVmomi.vim import ServiceInstance

_log = logging.getLogger("vmware-knight.log-scanner")
