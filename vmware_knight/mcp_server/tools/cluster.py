...
from vmware_knight.ops.gate import preview, refuse_on
...
def cluster_delete(
    ...
    """
    from vmware_knight.ops.cluster_gate import measure_cluster_delete
...
def cluster_remove_host(
    ...
    Args:
        ...
        target: Optional vCenter target name from config.
    """
    from vmware_knight.ops.cluster_gate import measure_host_removal
...
def list_drs_rules(cluster: str, target: Optional[str] = None) -> dict:
    ...
    """
    from vmware_knight.ops.cluster_mgmt import list_drs_rules as _list
    si = _get_connection(target)
...
def set_drs_rule_enabled(
    ...
    """
    from vmware_knight.ops.cluster_mgmt import set_drs_rule_enabled as _set
    si = _get_connection(target)
...
def create_drs_rule(
    ...
    """
    from vmware_knight.ops.cluster_mgmt import create_drs_rule as _create
    si = _get_connection(target)
    return _create(
...
def delete_drs_rule(
    ...
    """
    from vmware_knight.ops.cluster_mgmt import delete_drs_rule as _delete
    si = _get_connection(target)
