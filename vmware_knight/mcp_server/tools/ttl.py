...
def vm_set_ttl(
    ...
    """
    from vmware_knight.ops.ttl import measure_ttl
    from vmware_knight.ops.ttl import set_ttl as _set_ttl
...
def vm_cancel_ttl(vm_name: str) -> str:
    ...
    """
    from vmware_knight.ops.ttl import cancel_ttl as _cancel_ttl
...
def vm_list_ttl() -> dict:
    ...
    """
    from vmware_knight.ops.ttl import list_ttl as _list_ttl
    return _list_ttl()
...
def vm_clean_slate(
    ...
    Args:
        ...
        target: Optional vCenter/ESXi target name from config.
    """
    from vmware_knight.ops.ttl import measure_clean_slate
    from vmware_knight.ops.vm_gate import did_not_act
    from vmware_knight.ops.vm_lifecycle import clean_slate
    si = _get_connection(target)
