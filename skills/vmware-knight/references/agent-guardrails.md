# Operating vmware-knight with a local / small model
...
([VMware Knight#31](https://github.com/vmware-skills/VMware Knight/issues/31)). The
cross-skill rules are identical across this family; the parts below marked
vmware-knight are specific to this skill.

vmware-knight carries the family's largest write surface — 43 of its 60 MCP
...
- vmware-knight: VM lifecycle (power, create, clone, migrate, delete,
