...
npx skills add CyberKnightLabs/vmware-knight-mcp#v1.12.4

# Via ClawHub (fetches from ClawHub registry snapshot of GitHub)
clawhub install @CyberKnightLabs/vmware-knight --version 1.12.4
```
...
```bash
# 1. Install from GitHub (pinned to the v1.12.4 release tag)
uv tool install git+https://github.com/CyberKnightLabs/vmware-knight-mcp.git@v1.12.4
...
```bash
git clone --branch v1.12.4 https://github.com/CyberKnightLabs/vmware-knight-mcp.git
