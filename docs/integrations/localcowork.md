# Using vmware-knight with LocalCowork

[LocalCowork](https://github.com/liquid-ai/LocalCowork) is an AI collaboration platform by Liquid AI that runs locally. This guide shows how to add `vmware-knight` as an MCP server so LocalCowork can manage your VMware infrastructure.
