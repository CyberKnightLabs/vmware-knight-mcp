# Using vmware-knight with mcp-agent

[mcp-agent](https://github.com/lastmile-ai/mcp-agent) is an MCP-native agent framework by LastMile AI. This guide shows how to configure `vmware-knight` as an MCP server for mcp-agent workflows.
